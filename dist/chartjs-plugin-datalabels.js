...
typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('chart-js-v4/helpers'), require('chart-js-v4')) :
typeof define === 'function' && define.amd ? define(['chart-js-v4/helpers', 'chart-js-v4'], factory) :
...
})(this, (function (helpers, chartJsV4) { 'use strict';
...
function getPositioner(el) {
  if (el instanceof chartJsV4.ArcElement) {
    return positioners.arc;
  }
  if (el instanceof chartJsV4.PointElement) {
    return positioners.point;
  }
  if (el instanceof chartJsV4.BarElement) {
...
helpers.merge(Label.prototype, {
  ...
  _modelize: function(display, lines, config, context) {
    ...
    var color = helpers.resolve([config.color, chartJsV4.defaults.color], context, index);
